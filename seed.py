...
def example_data():
   ...
   # Add sample employees and departments
    ...
    ahmad = User(user_id=2 ,first_name="Ahmad", last_name="Alawad", age=30, email="ahmad@", password="doge2", image="http://static.wixstatic.com/media/28d5bc_4337310fc0af46cda44626c83452069b.jpg_256")
